...
const attendanceApproval = require("./routes/attendanceApproval.routes");

const attendanceSweep = require("./controllers/attendanceSweep");
attendanceSweep.init();
...
//     await User.updateMany({ lastSeen: { $lt: timeout } }, { isOnline: false });
//   } catch (err) {
...
//   if (req.headers["x-app-secret"] !== process.env.APP_CLIENT_SECRET) {
//     return res.status(403).send("Access restricted to the desktop app.");
//   }
//   next();
// });
