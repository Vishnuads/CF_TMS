...
// A tab is considered "gone dark" (asleep, suspended, network dead) if no
// heartbeat (join-user / presence-ping) has updated User.lastSeen within
// this window. Must be comfortably bigger than the frontend's ping interval
// and the socket disconnect grace timer (8s in socket.js) so normal blips
// never trip it.
